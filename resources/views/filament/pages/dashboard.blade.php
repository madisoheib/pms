<x-filament-panels::page>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        {{-- Suppliers --}}
        <a href="{{ route('filament.admin.resources.suppliers.index') }}"
        ...
        {{-- Wallets --}}
        <a href="{{ route('filament.admin.resources.wallets.index') }}"
        ...
        {{-- Transfer Money --}}
        <a href="{{ route('filament.admin.pages.transfer-money') }}"
        ...
        {{-- Transit Receipts --}}
        <a href="{{ route('filament.admin.resources.transit-receipts.index') }}"
        ...
        {{-- Credentials --}}
        <a href="{{ route('filament.admin.pages.credentials') }}"
