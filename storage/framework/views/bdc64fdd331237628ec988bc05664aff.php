...
<div class="flex flex-col gap-1.5 py-1">
    <?php $__empty_1 = true; $__currentLoopData = $items->take($displayLimit); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <?php
    ...
    <?php if($items->count() > $displayLimit): ?>
    ...
    <?php endif; ?>
</div><?php /**PATH /Users/p3f/www/out-workspace/PSM/resources/views/filament/tables/columns/order-products.blade.php ENDPATH**/ ?>